import { URGENT_DESCRIPTION, URGENT_LABEL } from "@/lib/domain/before-shipment-urgency";
 ...
 */
export function UrgentFlag({ urgent }: { urgent: boolean }) {
  if (!urgent) return null;
  return (
    <span
      title={URGENT_DESCRIPTION}
      aria-label={URGENT_DESCRIPTION}
